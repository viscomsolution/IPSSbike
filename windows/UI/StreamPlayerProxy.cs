...
namespace WebEye
{
    ...
    /// </summary>
    class StreamFailedEventArgs : EventArgs
    {
        /// <summary>
        /// The _error.
        /// </summary>
    ...
    /// </summary>
    sealed class StreamPlayerException : Exception
    {
        /// <summary>
    ...
    internal sealed class StreamPlayerProxy : IDisposable
    {
        ...
        {
            _dllFile = "StreamPlayer.dll";// Path.GetTempFileName();
            //using (var stream = new FileStream(_dllFile, FileMode.Create, FileAccess.Write))
            //{
            //    using (var writer = new BinaryWriter(stream))
            //    {
            //        writer.Write(IPSS.Properties.Resources.StreamPlayer);
            //    }
            //}
